...
public class CakeAdapter extends RecyclerView.Adapter<CakeAdapter.MyViewHolder> {
    private List<Cake> mdataList;
    private LayoutInflater mInflater;

    public  CakeAdapter(Context context, List<Cake> data){
        this.mdataList=data;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Cake currentobj=mdataList.get(position);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void setData(Cake current, int position) {
