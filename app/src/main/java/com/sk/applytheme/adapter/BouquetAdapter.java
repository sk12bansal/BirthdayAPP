...
public class BouquetAdapter extends RecyclerView.Adapter<BouquetAdapter.MyViewHolder> {
    ...
    private List<Bouquet> mdataList;
    private LayoutInflater mInflater;

    public  BouquetAdapter(Context context, List<Bouquet> data){
        this.mdataList=data;
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        Bouquet currentobj=mdataList.get(position);
    ...
    class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void setData(Bouquet current, int position) {
